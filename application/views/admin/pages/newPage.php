...
<head>
    ...
    <title>Yeni Sayfa Oluştur - Yönetim | Script Amca</title>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <ol class="breadcrumb">
                ...
                <li class="active">Yeni Sayfa Oluştur</li>
            </ol>
        </section>
        <br>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Yeni Sayfa Oluştur</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url('panel/create/page'); ?>" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                            <div class="box-body">
                                <div class="form-group col-md-7">
                                    <label for="exampleInputEmail1">Sayfa Başlığı</label>
                                    <input type="text" required="required" name="page_title" class="form-control">
                                </div>
                                <div class="form-group col-md-5">
                                    <label for="exampleInputPassword1">Sayfa Sloganı</label>
                                    <input type="text" name="page_tags" class="form-control">
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label for="exampleInputFile">Sayfa İçeriği</label>
                                        <textarea id="editor1" required="required" name="page_text" rows="10" cols="80"></textarea>
                                    </div>
                                </div>
