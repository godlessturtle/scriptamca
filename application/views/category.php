...
<head>
    ...
    <title><?php echo html_escape(getCatNameByID($catPosts[0]->post_category)); ?> &bull; Script Amca | <?php echo html_escape($settings[0]->set_title_suffix); ?></title>
    <!-- header -->
                ...
                <div class="tie-row main-content-row">
                    <div class="main-content tie-col-md-8 tie-col-xs-12" role="main">
                        <header class="entry-header-outer container-wrapper">
                            <nav id="breadcrumb"><a href="<?php echo base_url(); ?>"><span class="fa fa-home" aria-hidden="true"></span> Anasayfa</a><em class="delimiter">/</em><span class="current"><?php echo html_escape(getCatNameByID($catPosts[0]->post_category)); ?></span></nav><h1 class="page-title"><?php echo html_escape(getCatNameByID($catPosts[0]->post_category)); ?></h1><br></header><br>
